			...
			<div class="card card-custom position-relative overflow-hidden">
						...
						<div class="d-flex justify-content-between align-items-md-center flex-column flex-md-row">
							<div class="d-flex flex-column px-0 order-2 order-md-1">
								...
								<span class="d-flex flex-column font-size-h5 font-weight-bold text-white">
									<span>TICKET ID</span>
									<span><?php echo isset($single['contact_us_id'])? $single['contact_us_id']:""; ?></span>
								</span>
							</div>
							<h1 class="display-3 font-weight-boldest text-white order-1 order-md-2">PINK7 LEAD</h1>
						</div>
					</div>
				</div>
				<!--end::Invoice header-->
				<div class="row justify-content-center py-8 px-8 py-md-30 px-md-0">
					<div class="col-md-9">
						<!--begin::Invoice body-->
						<div class="row pb-26">
						    <div class="col-md-6 border-top pt-14 pb-10 pb-md-18">
								<div class="d-flex flex-column flex-md-row">
									<div class="d-flex flex-column">
										<div class="font-weight-bold font-size-h6 mb-3">CUSTOMER DETAILS</div>
										<?php if($single['contact_us_name']) { ?>
										<div class="d-flex justify-content-between font-size-lg mb-3">
											<span class="font-weight-bold mr-15">Name:</span>
											<span class="text-right"><?php echo isset($single['contact_us_name'])? $single['contact_us_name']:""; ?></span>
										</div>
										<?php } ?>
										<?php if($single['contact_us_phone']) { ?>
										<div class="d-flex justify-content-between font-size-lg mb-3">
											<span class="font-weight-bold mr-15">MOBILE:</span>
											<span class="text-right"><?php echo isset($single['contact_us_phone'])? $single['contact_us_phone']:''; ?></span>
										</div>
										<?php } ?>
										<?php if($single['contact_us_email']) { ?>
										<div class="d-flex justify-content-between font-size-lg">
											<span class="font-weight-bold mr-15">EMAIL:</span>
											<span class="text-right"><?php echo isset($single['contact_us_email'])? $single['contact_us_email']:''; ?></span>
										</div>
										<?php } ?>
										
										<?php if($single['contact_us_message']) { ?>
										<div class="d-flex justify-content-between font-size-lg">
											<span class="font-weight-bold mr-15">Message:</span>
											<span class="text-right"><?php echo isset($single['contact_us_message'])? $single['contact_us_message']:''; ?></span>
										</div>
										<?php } ?>
