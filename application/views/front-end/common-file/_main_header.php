...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?= base_url('front-end/') ?>css/swiper-bundle.min.css?v=<?=time()?>">
        <link rel="stylesheet" type="text/css" href="<?= base_url('front-end/') ?>css/component.css?v=<?=time()?>" />
        <script src="<?= base_url('front-end/') ?>js/modernizr.custom.js"></script>
    </head>
    <body>
