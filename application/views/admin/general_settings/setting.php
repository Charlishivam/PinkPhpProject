                    ...
                    <div role="tabpanel" class="tab-pane active" id="main">
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="mobile_number" placeholder="Mobile Number" value="<?php echo html_escape($general_settings['mobile_number']); ?>">
                        </div>
                        <div class="form-group">
                            <label class="control-label">Email</label>
                            <input type="email" class="form-control" name="email" placeholder="Email" value="<?php echo html_escape($general_settings['email']); ?>">
                        </div>
                        <div class="form-group">
