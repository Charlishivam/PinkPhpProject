<html lang="en">
  <!--begin::Head-->
    <meta charset="utf-8" />
    <title><?= base_url('admin'); ?>"><?= $this->general_settings['application_name']; ?></title>
        ...
        <div class="login-container order-2 order-lg-1 d-flex flex-center flex-row-fluid px-7 pt-lg-0 pb-lg-0 pt-4 pb-6 bg-white">
          ...
          <div class="login-content d-flex flex-column pt-lg-0 pt-12">
            ...
            <a href="#" class="login-logo pb-xl-20 pb-15">
              <img src="<?= base_url()?>assets/media/logos/logo-light.png" class="max-h-70px" alt="" />
            </a>
            <!--end::Logo-->
            <!--begin::Signin-->
            ...
            <div class="login-form">
              ...
              <?php echo form_open(base_url('admin/auth/login'), 'class="form" '); ?>
                ...
                <div class="form-group">
                  ...
                  <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0" type="text" name="username" id="name" placeholder="Username" autocomplete="off" />
                </div>
                <!--end::Form group-->
                <!--begin::Form group-->
                <div class="form-group">
                  ...
                  <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0" type="password" name="password" id="password" placeholder="Password" autocomplete="off" />
                </div>
                <!--end::Form group-->
                <!--begin::Action-->
                <div class="pb-lg-0 pb-5">
                  
                  <input type="submit" name="submit" id="submit" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3" value="Sign In">
