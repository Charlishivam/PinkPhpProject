            ...
            <div class="row">
               ...
               <div class="col-md-6">
                   <div class="form-group">
                     ...
                     <div class="col-md-12">
                        <input type="text" name="testimonial_subtitle"  class="form-control"  id="testimonial_subtitle" placeholder="Enter Sub-title" value="<?= set_value('testimonial_subtitle',$single->testimonial_subtitle) ?>">
               ...
               <div class="col-md-12">
                   <div class="form-group">
                     <label for="testimonial_content" class="col-md-12 control-label">Testimonial Description<span class="text-red" style="color:red">*</span></label>
                      ...
                      <div class="col-md-12">
                        <textarea type="text" name="testimonial_description" class="form-control updateeditor"><?= $single->testimonial_description ?></textarea>
             ...
             <div class="row">
               ...
               <div class="col-md-6">
                   <div class="form-group">
                     ...
                     <div class="col-md-12">
                         <img id="blah" src="<?= base_url('uploads/testimonial/'.$single->testimonial_image); ?>" width="150" height="150"/>
                     </div>
                  </div>
               </div>
            </div>
