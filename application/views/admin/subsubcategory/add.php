...
<div class="content-wrapper">
   ...
   <section class="content">
      <div class="card card-default">
         ...
         <div class="card-body">
            <form method="POST" action="<?= base_url()."admin/subsubcategory/add" ?>" enctype="multipart/form-data">
            ...
            <div class="row">
               <div class="col-md-12">
                   <div class="form-group">
                     ...
                     <div class="col-md-12">
                         <input type="text" name="greeting_name" required="" value="<?= set_value('greeting_name') ?>" class="form-control" id="greeting_name" placeholder="Enter Title" >
                     </div>
                  </div>
               </div>
            </div>  
            ...
            <div class="row">
               <div class="col-md-12">
                   <div class="form-group">
                     ...
                     <div class="col-md-12">
                         <textarea  name="greeting_description" required="" class="form-control"><?= set_value('greeting_description') ?></textarea>
                     </div>
                  </div>
               </div>
            </div>  
             ...
             <div class="row">
               <div class="col-md-12">
                   <div class="form-group">
                     ...
                     <div class="col-md-12">
                         <?= form_dropdown('greeting_cat_id',$parents,set_value('greeting_cat_id'),'class="form-control" required id="greeting_cat_id"') ?>
            ...
            <div class="row">
               <div class="col-md-12">
                   <div class="form-group">
                     ...
                     <div class="col-md-12">
                         <?= form_dropdown('greeting_sub_cat_id',$cat_parents,set_value('greeting_sub_cat_id'),'class="form-control" required id="greeting_sub_cat_id"') ?>
             ...
             <div class="row">
               <div class="col-md-12">
                   <div class="form-group">
                     ...
                     <div class="col-md-12">
                         <?= form_dropdown('greeting_event_id',$all_event,set_value('greeting_event_id'),'class="form-control" id="greeting_event_id"') ?>
             ...
             <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="title" class="from-control">Select Tag<span class="text-red" style="color:red">*</span></label>
                     <div class="col-md-12">
                        <?= form_dropdown('tag_id[]',$tags,set_value('tag_id[]'),'class="form-control getsubcat" id="kt_select2_4" required multiple="multiple"') ?>
            ...
            <div class="form-group">
               <div class="col-md-12">
                  <input type="submit"  name="submit" value="Add Teamplates" class="btn btn-primary pull-right">
               </div>
            </div>
            <?php echo form_close( ); ?>
         </div>
...
<script type="text/javascript">
  $('#kt_select2_7').select2({
         placeholder: "Select a Subcatgeory",
        });
</script>
