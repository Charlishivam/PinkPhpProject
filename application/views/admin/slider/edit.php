...
<div class="content-wrapper">
   ...
   <section class="content">
      <div class="card card-default">
         ...
         <div class="card-body">
            <form method="POST" action="<?= base_url()."admin/slider/edit" ?>" enctype="multipart/form-data">
               ...
               <div class="col-md-12">
                   <div class="form-group">
                     ...
                     <div class="col-md-12">
                        ...
                        <?= form_dropdown('slider_type',[''=>'Select Slider Type','1'=>'Slider','2'=>'Banner'],set_value('slider_type',$single->slider_type),'class="form-control" id="slider_type"'); 
                        ?>
            ...
            <div class="row">
               <div class="col-md-12">
                   <div class="form-group">
                     ...
                     <div class="col-md-12">
                        <input type="number" name="slider_position" required="" class="form-control" id="slider_position" value="<?= set_value('slider_position',$single->slider_position) ?>" placeholder="Slider Position">
            ...
            <div class="form-group">
              <img id="blah" src="<?= base_url('uploads/slider/'.$single->slider_image); ?>" width="150" height="150"/>
            </div>
            <div class="form-group">
               <div class="col-md-12">
