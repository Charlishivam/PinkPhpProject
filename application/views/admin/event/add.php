...
<div class="content-wrapper">
   ...
   <section class="content">
      <div class="card card-default">
         ...
         <div class="card-body">
            <form method="POST" action="<?= base_url()."admin/event/add" ?>" enctype="multipart/form-data">
            ...
            <div class="row">
               <div class="col-md-12">
                   <div class="form-group">
                     ...
                     <div class="col-md-12">
                        <input type="text" name="upcomming_events_title" required="" class="form-control" id="upcomming_events_title" placeholder=" Enter Events Title ">
                     </div>
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-md-12">
                   <div class="form-group">
                     ...
                     <div class="col-md-12">
                         <input type="date" class="form-control" name="upcomming_events_date"  placeholder="Start Date" />
            ...
            <div class="row">
               <div class="col-md-12">
                   <div class="form-group">
                     ...
                     <div class="col-md-12">
                         <input type="time" class="form-control" name="upcomming_events_time"  placeholder="Start time" />
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="form-group">
               <div class="col-md-12">
                  <input type="submit"  name="submit" value="Add Event" class="btn btn-primary pull-right">
               </div>
            </div>
            <?php echo form_close( ); ?>
         </div>
