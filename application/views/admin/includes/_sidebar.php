...
<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
   ...
   <div class="brand flex-column-auto" id="kt_brand" kt-hidden-height="65" style="">
      ...
      <img alt="Logo" src="<?= base_url() ?>assets/media/logos/pink7-logo.png">
      </a>
      <!--end::Logo-->
      <!--begin::Toggle-->
         ...
         <ul class="menu-nav">
            ...
            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
               ...
               <div class="menu-submenu">
                  ...
                  <ul class="menu-subnav">
                     ...
                     <li class="menu-item" aria-haspopup="true">
                        <a href="<?= base_url('admin/category/add'); ?>" class="menu-link">
                        <i class="menu-bullet menu-bullet-dot">
                        <span></span>
                        </i>
               ...
               <div class="menu-submenu">
                  ...
                  <ul class="menu-subnav">
                     <li class="menu-item" aria-haspopup="true">
                        ...
                        <span class="menu-text">List Sub Category</span>
                        </a>
                     </li>
                     <li class="menu-item" aria-haspopup="true">
                        <a href="<?= base_url('admin/subcategory/add'); ?>" class="menu-link">
                        <i class="menu-bullet menu-bullet-dot">
                        <span></span>
                        </i>
            ...
            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
               ...
               <div class="menu-submenu">
                  ...
                  <ul class="menu-subnav">
                     <li class="menu-item" aria-haspopup="true">
                        <a href="<?= base_url('admin/tags/'); ?>" class="menu-link">
                        <i class="menu-bullet menu-bullet-dot">
                        <span></span>
                        </i>
                     ...
                     <li class="menu-item" aria-haspopup="true">
                        <a href="<?= base_url('admin/tags/add'); ?>" class="menu-link">
                        <i class="menu-bullet menu-bullet-dot">
                        <span></span>
                        </i>
               ...
               <div class="menu-submenu">
                  ...
                  <ul class="menu-subnav">
                     <li class="menu-item" aria-haspopup="true">
                        ...
                        <span class="menu-text">List Event</span>
                        </a>
                     </li>
                     <li class="menu-item" aria-haspopup="true">
                        <a href="<?= base_url('admin/event/add'); ?>" class="menu-link">
                        <i class="menu-bullet menu-bullet-dot">
                        <span></span>
                        </i>
            ...
            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
               <a href="javascript:;" class="menu-link menu-toggle">
                  ...
                  <span class="menu-text">Client's Logo</span>
                  <i class="menu-arrow"></i>
               </a>
               <div class="menu-submenu">
                  <i class="menu-arrow"></i>
                  <ul class="menu-subnav">
                     <li class="menu-item" aria-haspopup="true">
                        <a href="<?= base_url('admin/client'); ?>" class="menu-link">
                        <i class="menu-bullet menu-bullet-dot">
                        <span></span>
                        </i>
                        <span class="menu-text">Client's Logo</span>
                     ...
                     <li class="menu-item" aria-haspopup="true">
                        <a href="<?= base_url('admin/client/add'); ?>" class="menu-link">
                        <i class="menu-bullet menu-bullet-dot">
                        <span></span>
                        </i>
                        <span class="menu-text">Add Client's Logo</span>
                        </a>
                     </li>
                  </ul>
               </div>
               ...
               <div class="menu-submenu">
                  ...
                  <ul class="menu-subnav">
                     <li class="menu-item" aria-haspopup="true">
                        ...
                        <span class="menu-text">List Templates</span>
                        </a>
                     </li>
                     <li class="menu-item" aria-haspopup="true">
                        <a href="<?= base_url('admin/subsubcategory/add'); ?>" class="menu-link">
                        <i class="menu-bullet menu-bullet-dot">
                        <span></span>
                        </i>
                        <span class="menu-text">Add Template</span>
                        </a>
                     </li>
                  </ul>
               </div>
            ...
            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
               ...
               <span class="menu-text">Subcriprion Package</span>
               <i class="menu-arrow"></i>
               </a>
               <div class="menu-submenu">
                  <i class="menu-arrow"></i>
                  <ul class="menu-subnav">
                     <li class="menu-item" aria-haspopup="true">
                        <a href="<?= base_url('admin/subscription'); ?>" class="menu-link">
                        <i class="menu-bullet menu-bullet-dot">
                        <span></span>
                        </i>
                        <span class="menu-text">List Package</span>
                        </a>
                     </li>
                     <!--<li class="menu-item" aria-haspopup="true">-->
                     <!--   <a href="<?= base_url('admin/subscription/add'); ?>" class="menu-link">-->
                     <!--   <i class="menu-bullet menu-bullet-dot">-->
                     <!--   <span></span>-->
                     <!--   </i>-->
            ...
            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
               ...
               <span class="menu-text">Website Contact</span>
               <i class="menu-arrow"></i>
               </a>
               <div class="menu-submenu">
                  <i class="menu-arrow"></i>
                  <ul class="menu-subnav">
                     <li class="menu-item" aria-haspopup="true">
                        <a href="<?= base_url('admin/contactus'); ?>" class="menu-link">
                        <i class="menu-bullet menu-bullet-dot">
                        <span></span>
                        </i>
            ...
            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
               ...
               <span class="menu-text">Subcriprion Purchase</span>
               <i class="menu-arrow"></i>
               </a>
               <div class="menu-submenu">
                  <i class="menu-arrow"></i>
                  <ul class="menu-subnav">
                     <li class="menu-item" aria-haspopup="true">
                        <a href="<?= base_url('admin/purchasesubscription'); ?>" class="menu-link">
                        <i class="menu-bullet menu-bullet-dot">
                        <span></span>
                        </i>
                        <span class="menu-text">List Package Purchase</span>
                        </a>
                     </li>
