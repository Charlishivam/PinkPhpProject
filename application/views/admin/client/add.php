...
<div class="content-wrapper">
   ...
   <section class="content">
      <div class="card card-default">
         ...
         <div class="card-body">
            <form method="POST" action="<?= base_url()."admin/client/add" ?>" enctype="multipart/form-data">
            ...
            <div class="row">
               <div class="col-md-12">
                   <div class="form-group">
                     ...
                     <div class="col-md-12">
                        <input type="text" name="client_title" class="form-control" id="client_title" placeholder="Enter Client Title">
            ...
            <div class="form-group">
               <div class="col-md-12">
                  <input type="submit"  name="submit" value="Add Client" class="btn btn-primary pull-right">
               </div>
            </div>
            <?php echo form_close( ); ?>
         </div>
