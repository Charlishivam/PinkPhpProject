         ...
         <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 col-12">
            ...
            <div class="message-box mb-4 mt-4">
               <div class="mb-2" id="msg_position">
                  <h6 class="mb-2">Logo Position</h6><hr>
                  <div class="custom-control custom-radio custom-control-inline mt-2">
                     <input type="radio" id="msgpos1" name="logo_position" class="custom-control-input position" value="top_left" checked>
                     <label class="custom-control-label" for="msgpos1">Top Left</label>
                  </div>
                  <div class="custom-control custom-radio custom-control-inline mt-2">
                     <input type="radio" id="msgpos2" name="logo_position" class="custom-control-input position" value="bottom_left" >
                     <label class="custom-control-label" for="msgpos2">Bottom Left</label>
                  </div>
                  <div class="custom-control custom-radio custom-control-inline mt-2">
                     <input type="radio" id="msgpos3" name="logo_position" class="custom-control-input position" value="top_right" >
                     <label class="custom-control-label" for="msgpos3">Top Right</label>
                  </div>
                  <div class="custom-control custom-radio custom-control-inline mt-2">
                     <input type="radio" id="msgpos4" name="logo_position" class="custom-control-input position" value="bottom_right">
                        ...
                        <div class="card text-center">
                           ...
                           <div class="custom-control custom-control-inline mb-2">
                              <?php if($connection['tw_connection'] == true){ ?>
                                  <!--<label for="toogles2" class="switch">-->
                                  <!--<input type="checkbox" class="custom-control-input position" value="twitter" id="toogles2">-->
