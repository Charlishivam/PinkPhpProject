                                    ...
                                    <?php   
                                      ...
                                      ?>
                                        <?if(!empty($pkgresultmonth)): ?>
                                          <a href="javascript:"<button type="button" class="btn-a-sm mr-2">Active <i class="fa fa-arrow-right"></i></button></a>
                                        <?php endif; ?>
                                        <?if(empty($pkgresultmonth)): ?>
                                          <a href="<?= base_url()."subscription/index/".$package_month_value->ci_sp_id ?>"<button type="submit" class="btn-a-sm mr-2">Get-started <i class="fa fa-arrow-right"></i></button></a>
                                        <?php endif; ?>
                                    <?php else: ?>
                                         <a href="<?= base_url()."subscription/index/".$package_month_value->ci_sp_id ?>"<button type="submit" class="btn-a-sm mr-2">Get-started <i class="fa fa-arrow-right"></i></button></a>
                                    <?php endif; ?>
                                ...
                                <div class="pricing-button">
                                    ...
                                    <?php   
                                      ...
                                      ?>
                                        ...
                                        <?php endif; ?>
                                        <?if(empty($pkgresult)): ?>
                                          <a href="<?= base_url()."subscription/index/".$package_year_value->ci_sp_id ?>"<button type="submit" class="btn-a-sm mr-2">Get-started <i class="fa fa-arrow-right"></i></button></a>
                                        <?php endif; ?>
                                    <?php else: ?>
                                         <a href="<?= base_url()."subscription/index/".$package_year_value->ci_sp_id ?>"<button type="submit" class="btn-a-sm mr-2">Get-started <i class="fa fa-arrow-right"></i></button></a>
                                    <?php endif; ?>
