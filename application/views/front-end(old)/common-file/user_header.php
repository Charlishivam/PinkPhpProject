      ...
      <section class="merchant">
         <div class="container">
            <div class="board pt-5">
               <?php if(!empty(user_detail())): ?>
                   <h2><?= ucwords(user_detail()->customer_name) ?> Dashboard</h2>
                   <p><?= ucwords(user_detail()->customer_name) ?></p>
                   <p>Phone: +91-<?= user_detail()->customer_mobile ?> &nbsp Email: <?= user_detail()->customer_email ?></p>
                <?php else: ?>
                   <h2></h2>
                <?php endif; ?>
            </div>
